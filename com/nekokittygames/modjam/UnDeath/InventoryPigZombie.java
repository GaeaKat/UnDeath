...
public class InventoryPigZombie implements IInventory {
	...
	public ItemStack[] mainInventory = new ItemStack[36];
	 ...
	 public int currentItem;
	    ...
	    public EntityPlayerZombiePigmen playerPigZombie;
	    ...
	    public InventoryPigZombie(EntityPlayerZombiePigmen playerPigZombie)
	    {
	    	this.playerPigZombie=playerPigZombie;
	    }
	    ...
	    public boolean addItemStackToInventory(ItemStack par1ItemStack)
	    {
	        ...
	        else
	        {
	            ...
	            catch (Throwable throwable)
	            {
	                ...
	                crashreportcategory.addCrashSectionCallable("Item name", new CallablePigZombieItemName(this, par1ItemStack));
	    ...
	    public void damageArmor(float par1)
	    {
	        ...
	        for (int i = 0; i < this.armorInventory.length; ++i)
	        {
	            ...
	            {
	                this.armorInventory[i].damageItem((int)par1, this.playerPigZombie);
	    ...
	    public void dropAllItems()
	    {
	        ...
	        for (i = 0; i < this.mainInventory.length; ++i)
	        {
	            if (this.mainInventory[i] != null)
	            {
	                this.playerPigZombie.entityDropItem(this.mainInventory[i], 0.0f);
	        ...
	        for (i = 0; i < this.armorInventory.length; ++i)
	        {
	            if (this.armorInventory[i] != null)
	            {
	                this.playerPigZombie.entityDropItem(this.armorInventory[i], 0.0f);
	                this.armorInventory[i] = null;
	            }
	        }
	    }
