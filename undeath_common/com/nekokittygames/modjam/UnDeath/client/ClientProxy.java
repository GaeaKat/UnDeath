...
public class ClientProxy extends ServerProxy {
    ...
    public void SetupRenderers() {
        RenderingRegistry.registerEntityRenderingHandler(
                EntityPlayerZombie.class, new RenderPlayerZombie());
        RenderingRegistry.registerEntityRenderingHandler(
                EntityPlayerSkellington.class, new RenderPlayerSkellington());
        RenderingRegistry.registerEntityRenderingHandler(
                EntityPlayerSlime.class, new RenderPlayerSlime(new ModelSlime(
                        16), new ModelSlime(0), 0.25f));
        RenderingRegistry.registerEntityRenderingHandler(
                EntityPlayerZombiePigmen.class, new RenderPlayerPigZombie());
    }
}
