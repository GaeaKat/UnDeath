...
public class ItemSpawner extends Item {
     ...
     */
    public static Entity spawnCreature(World par0World, int itemDamage,
            double par2, double par4, double par6, EntityPlayer par7EntityPlayer) {
        ...
        for (int j = 0; j < 1; ++j) {
            ...
            if (entity != null && entity instanceof EntityLivingBase) {
                ...
                if (itemDamage == EntityPlayerZombie.EntityId) {
                    ((EntityPlayerZombie) entityliving)
                            .InitFromPlayer(par7EntityPlayer);
                } else if (itemDamage == EntityPlayerSkellington.EntityId) {
                    ((EntityPlayerSkellington) entityliving)
                            .InitFromPlayer(par7EntityPlayer);
                } else if (itemDamage == EntityPlayerSlime.EntityId) {
                    ((EntityPlayerSlime) entityliving).InitFromPlayer(
                            par7EntityPlayer, null);
                } else if (itemDamage == EntityPlayerZombiePigmen.EntityId) {
                    ((EntityPlayerZombiePigmen) entityliving)
                            .InitFromPlayer(par7EntityPlayer);
                }
    ...
    public String getItemDisplayName(ItemStack par1ItemStack) {
        ...
        final String s1 = EntityList.getStringFromID(par1ItemStack
                .getItemDamage());
            ...
            if (movingobjectposition == null)
                ...
                if (movingobjectposition.typeOfHit == EnumMovingObjectType.TILE) {
                    ...
                    if (par2World.getBlockMaterial(i, j, k) == Material.water) {
                        final Entity entity = spawnCreature(par2World,
    ...
    public boolean onItemUse(ItemStack par1ItemStack,
        ...
        if (par3World.isRemote)
            ...
            final Entity entity = spawnCreature(par3World,
                    par1ItemStack.getItemDamage(), par4 + 0.5D, par5 + d0,
