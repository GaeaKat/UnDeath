        ...
        if (par1ItemStack == null)
            ...
            try {
                ...
                crashreportcategory.addCrashSectionCallable("Item name",
                        new CallableSkellingtonItemName(this, par1ItemStack));
    ...
    public void damageArmor(float par1) {
        ...
        for (int i = 0; i < armorInventory.length; ++i) {
            if (armorInventory[i] != null
                ...
                armorInventory[i].damageItem((int) par1, playerSkellington);
    ...
    public void dropAllItems() {
        ...
        for (i = 0; i < mainInventory.length; ++i) {
            if (mainInventory[i] != null) {
                playerSkellington.entityDropItem(mainInventory[i], 0.0f);
        ...
        for (i = 0; i < armorInventory.length; ++i) {
            if (armorInventory[i] != null) {
                playerSkellington.entityDropItem(armorInventory[i], 0.0f);
                armorInventory[i] = null;
            }
        }
    }
