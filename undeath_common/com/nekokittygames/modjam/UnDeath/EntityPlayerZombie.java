 ...
 * 
 */
public class EntityPlayerZombie extends EntityZombie implements
    ...
    private static final ResourceLocation   overlay        = new ResourceLocation(
                                                                   "undeath",
                                                                   "textures/entity/playerZombie.png");
    ...
    public void BuildLayeredName() {
        LayeredName = "skins/" + StringUtils.stripControlCodes(getZombieName())
                + "/zombie";
    }
    ...
    public ResourceLocation func_110299_g(String par0Str) {
        return new ResourceLocation("zcloaks/"
    ...
    protected void func_110302_j() {
        ...
        if (this.getZombieName() != null && !this.getZombieName().isEmpty()) {
            mmmm = func_110311_f(this.getZombieName());
            tsch = func_110299_g(this.getZombieName());
            field_110316_a = func_110304_a(mmmm, this.getZombieName());
            field_110315_c = func_110307_b(tsch, this.getZombieName());
        }
    }
    ...
    public ResourceLocation func_110305_h(String par0Str) {
        return new ResourceLocation("zskull/"
                + StringUtils.stripControlCodes(par0Str));
    }
